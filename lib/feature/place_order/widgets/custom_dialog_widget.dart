...
class CustomDailogWidget extends StatelessWidget {
  const CustomDailogWidget({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: CustomButtonWidget(isSvg: false, title: "Submit", onTap: () {
                ...
                Gap(20),
                Expanded(
                  child: CustomButtonWidget(isSvg: false, title: "Cancel", onTap: () {
                    Navigator.pop(context);
                  }),
                ),
              ],
